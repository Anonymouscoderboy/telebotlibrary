...
replies = {
    ...
    'your name': 'मेरा नाम ChatBot है।',
    'kaha se ho': 'मैं एक AI आधारित बॉट हूँ और मेरी स्थानवाली सर्वर पर स्थापित हूँ।',
    'aapko kya pasand hai': 'मुझे भाषा समझना और उपयोगकर्ताओं की मदद करना पसंद है।',
    'favorite color': 'मेरा पसंदीदा रंग हरा है।',
    ...
    'din kaisa raha': 'मेरा दिन अच्छा रहा, धन्यवाद।',
    'aapko koi bimari hai': 'नहीं, मैं एक AI बॉट हूँ, मुझे बीमारी नहीं होती।',
    'kya kar sakte ho': 'मैं आपको विभिन्न विषयों पर जानकारी देने, सवालों का उत्तर देने और मदद करने में सक्षम हूँ।',
    'kya tumko piyar hai': 'हाँ, मैं आपसे प्यार करता हूँ ❤',
